module kubedb.dev/redis-node-finder
...
require (
	...
	kubedb.dev/apimachinery v0.47.0-rc.0.0.20240709094513-f8063159adec
)
...
require (
	...
	kmodules.xyz/offshoot-api v0.29.5-0.20240705043904-bb118b293ce9 // indirect
