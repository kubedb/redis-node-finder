module github.com/Shaad7/redis-node-finder
...
replace (
	go.etcd.io/etcd/client/pkg/v3 => github.com/kubedb/etcd-io/client/pkg/v3 v3.5.0-beta.4.0.20211116114855-905611241c69
	go.etcd.io/etcd/raft/v3 => github.com/kubedb/etcd-io/raft/v3 v3.5.0-beta.4.0.20211116114855-905611241c69
	go.etcd.io/etcd/server/v3 => github.com/kubedb/etcd-io/server/v3 v3.5.0-beta.4.0.20211116114855-905611241c69
)
